...
class HTMLTests(unittest.TestCase):
    def test_html_integrity_and_labels(self):
        ...
        self.assertEqual(p.scripts,["core.js?v=5.6-exact-money","locations.js?v=2026-09-07-map-choice-1","app.js?v=5.6-map-direct-1"])
    ...
    def test_settings_fields_keep_their_layout_groups_and_readonly_rates(self):
        ...
        self.assertIn('href="styles.css?v=5.6-map-direct-1"', source)
